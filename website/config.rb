...
set :markdown, autolink: true, filter_html: true, hard_wrap: true
...
activate :deploy do |deploy|
  ...
  # deploy.remote = "git@gitcafe.com:merusuto/merusuto.git"
  # deploy.branch = "gitcafe-pages"

  # deploy.remote = "git@git.coding.net:bbtfr/merusuto.git"
